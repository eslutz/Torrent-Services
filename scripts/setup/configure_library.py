...
from common import (
    load_env, log, get_api_key, wait_for_service, 
    configure_config_endpoint, configure_root_folders, get_headers
)
...
def main():
    ...
    configure_config_endpoint(
        sonarr_url, sonarr_api_key, "mediamanagement",
    ...
    # 2. Configure Media Management (Hardlinks)
    configure_config_endpoint(
        radarr_url, radarr_api_key, "mediamanagement",
        {"copyUsingHardlinks": True, "importExtraFiles": True, "extraFileExtensions": "srt,nfo"},
        "Media Management"
    )
